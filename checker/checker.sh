...
function test1 {
	...
	cp tests/test1/* .
	correct=0
	run_timeout "mpirun --oversubscribe -np 4 ./mpitorrent"
...
function test2 {
	...
	cp tests/test2/* .
	correct=0
	run_timeout "mpirun --oversubscribe -np 6 ./mpitorrent"
...
function test3 {
	...
	cp tests/test3/* .
	correct=0
	run_timeout "mpirun --oversubscribe -np 5 ./mpitorrent"
...
function test4 {
	...
	cp tests/test4/* .
	correct=0
	run_timeout "mpirun --oversubscribe -np 7 ./mpitorrent"
	compare_files client3_file1 out1.txt
